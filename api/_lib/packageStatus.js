...
// zero rows and can't resurrect the card to complete/failed. Both call
// sites — packages/[id].js, renderPackageChannels.js — MUST
...
export const CANCELABLE_STATUSES = ['generating', 'pending']

// PostgREST `status=in.(...)` filter fragment (no leading `&`).
