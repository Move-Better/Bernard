...
async function handler(req, res) {
  ...
  if (STRIPE_WEBHOOK_SECRET) {
    ...
    // Fail closed on any deployed env (production or preview) — never accept unsigned webhooks.
    console.error('[billing/webhook] STRIPE_WEBHOOK_SECRET not configured — refusing unsigned request in', process.env.VERCEL_ENV)
