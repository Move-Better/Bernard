...
function CampaignChip({ campaign }) {
  const styleClass = {
    ...
    relationship: 'bg-scheduled/10 text-scheduled border-scheduled/20',
          ...
          <>
            <div className="absolute top-2 left-2 flex gap-1 flex-wrap">
              {pkg.broll_status === 'complete' ? (
                <span
                  className="inline-flex items-center gap-1 rounded-md px-1.5 py-0.5 text-3xs font-bold text-warning-foreground bg-warning/80 backdrop-blur-sm"
