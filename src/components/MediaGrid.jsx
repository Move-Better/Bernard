...
// color everywhere. Sky = tagged/ready, faint = raw/archived. Only the three
// live statuses appear — 'rendered' and 'approved' were retired (see the note
// on MediaHub's STATUS_FILTERS); any unknown value falls through to the
// neutral raw tone at the lookup below.
const STATUS_LABEL = {
