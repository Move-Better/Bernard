...
function VideoTrimStage({ video, onBack, onClose, onContinue }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4" role="dialog" aria-modal="true" aria-label="Trim clip for ads">
          ...
          {!ready && metaFailed && (
            <div className="mt-3 flex gap-1.5 rounded-lg border border-warning bg-warning/10 p-2.5 text-2xs text-muted-foreground">
              ...
              <span>
                ...
                Try another clip, or trim it on <span className="font-semibold">Moments</span> once it&rsquo;s ready.
              </span>
            </div>
          )}
