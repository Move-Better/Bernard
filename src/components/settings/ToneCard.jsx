...
export function ToneCard({ toneObj, label, value, onChange, systemDefault }) {
  ...
  return (
    <div className={`rounded-lg border ${hasContent ? 'border-input' : 'border-dashed border-input/60'} bg-card overflow-hidden`}>
      <Accordion type="single" collapsible>
        <AccordionItem value="tone" className="border-0">
          <AccordionTrigger className="w-full flex items-center gap-2.5 px-3 py-2.5 hover:bg-accent/30 hover:no-underline rounded-lg text-left">
