...
const AVATAR_COLORS = ['hsl(var(--primary))', '#058ac7', '#7c3aed', '#6366f1', '#0284c7', '#059669', '#d97706']
        ...
        <div className="rounded-xl border border-border bg-card overflow-x-auto">
          <table className="border-collapse w-max min-w-full text-sm">
            ...
            <thead className="sticky top-0 z-10">
              {/* group row */}
              <tr>
                <th scope="col" aria-label="Team member" className="sticky left-0 z-20 bg-card border-b border-border min-w-[220px]" />
              ...
              <tr>
                <th scope="col" aria-label="Team member" className="sticky left-0 z-20 bg-card border-b-2 border-border border-r-2 border-r-border min-w-[220px]" />
                {CAPABILITY_GROUPS.map((g) =>
                  g.caps.map((cap, i) => (
                    <th
                      key={cap}
