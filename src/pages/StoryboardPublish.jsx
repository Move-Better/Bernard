...
export default function StoryboardPublish() {
  ...
  return (
    <div className="space-y-5 py-6">
      ...
      {/* Carousel: full-width active-canvas editor — no fixed left preview pane.
          The canvas inside SlideEditor IS the live preview. All other formats
          (Reels, Facebook, LinkedIn, GBP) keep the two-column preview layout. */}
      {isCarousel ? (
