...
export default function WorkspaceSettings() {
  ...
  return (
    <div className="space-y-6 pb-16">
      ...
      <div className="md:sticky md:top-0 z-20 py-4 bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/70 border-b border-border/60 flex items-start justify-between gap-4">
