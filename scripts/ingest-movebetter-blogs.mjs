...
const WORKSPACES = {
  people: {
    ...
    // People site has NarrateRx-published posts mixed in. Only ingest
  ...
  animals: {
    ...
    blogPath:       'src/content/blog',
    // Animals site has no NarrateRx-generated posts — ingest everything.
...
async function processWorkspace(wsKey) {
  ...
  for (const filename of filenames) {
    ...
    try {
      ...
      // Skip NarrateRx-generated posts in workspaces where they can exist.
      // verbatim:true marks text the clinician actually wrote; anything without
      // it was generated by the NarrateRx pipeline and must not train their voice.
      if (ws.requireVerbatim && fields.verbatim !== 'true') {
        console.log(`  SKIP (NarrateRx-generated)  ${slug}`)
        skipped++
        continue
      }
